# Hi there, I'm Semiu Ademola Adesina 👋
...
* **Medication Error Reporting App:** Designed a mobile-first system used across 5+ departments, reducing error recording delays by **60%** and replacing paper-based workflows.
...
* **Diploma in Backend Development** | AltSchool Africa
* **BPharm** | University of Ibadan

**Certifications:**
* 🏅 **IBM:** Cloud Native, DevOps & Agile, Docker & Kubernetes
* 🏅 **IBM:** Developing Back-End Apps with Node.js and Express
* 🏅 **IBM:** Data Structures & Algorithms Foundations
...
- **Portfolio**: [My Portfolio](https://thedamozportfolio.com)
